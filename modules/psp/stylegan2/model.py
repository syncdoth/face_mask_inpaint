...
from modules.psp.stylegan2.op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d
...
class Generator(nn.Module):
    ...
    def __init__(
        ...
        for i in range(n_mlp):
            layers.append(
                EqualLinear(style_dim, style_dim, lr_mul=lr_mlp,
...
class Discriminator(nn.Module):
    ...
    def forward(self, input):
        ...
        stddev = out.view(group, -1, self.stddev_feat, channel // self.stddev_feat,
                          height, width)
