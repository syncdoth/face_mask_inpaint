# code implementation from https://github.com/hukkelas/pytorch-frechet-inception-distance/blob/master/fid.py
...
def calculate_fid(images1, images2, use_multiprocessing, batch_size):
    ...
    Args:
        ...
        images2: tensor, shape: (N, 3, H, W), dtype: np.float32 between 0-1 or np.uint8
        batch size: batch size used for inception network
    Returns:
        FID (scalar)
    """
